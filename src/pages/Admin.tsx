...
export default function Admin() {
  ...
  const handleSaveEmployee = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Also sync vorname/nachname to profiles table if employee is linked to a user
      if (selectedEmployee.user_id && (formData.vorname !== undefined || formData.nachname !== undefined)) {
        await supabase
          .from("profiles")
          .update({
            vorname: formData.vorname ?? selectedEmployee.vorname,
            nachname: formData.nachname ?? selectedEmployee.nachname,
          })
