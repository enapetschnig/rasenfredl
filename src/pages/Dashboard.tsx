      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <img src="/newlogo.png" alt="Rasen Maierhold" className="h-16 w-auto object-contain" />
            <div>
              <h1 className="text-4xl font-bold text-foreground">Rasen Maierhold</h1>
              <p className="text-muted-foreground">Zeiterfassung & Projektverwaltung</p>
            </div>
          </div>
        </div>
