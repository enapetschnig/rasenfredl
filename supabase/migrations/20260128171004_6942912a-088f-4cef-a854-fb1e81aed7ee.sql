-- Teil 1: Fehlenden User "Max Mustermann" manuell einfügen (nur wenn in auth.users vorhanden)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM auth.users WHERE id = 'f4556eed-6e68-4840-b1f2-e773f792680f') THEN
